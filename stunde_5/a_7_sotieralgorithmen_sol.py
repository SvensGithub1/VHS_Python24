...
if __name__ == "__main__":
    ...
    so_time_3 = []
    so_time_4 = []
    samples = [10000, 11000, 12000 ,13000, 14000, 15000, 16000, 18000, 20000]
    for sample_size in samples :
        
        random_integers = [random.randint(1, 100) for _ in range(sample_size)]
        ...
        #print(random_integers)
        total = t1-t0
        so_time_4.append(total)
        
    plt.plot(samples, so_time_1, marker='o', label='native')
    plt.plot(samples, so_time_2, marker='o', label='bubble')
    plt.plot(samples, so_time_3, marker='o', label='bubble beschl')
    plt.plot(samples, so_time_4, marker='o', label='quick')
    
    plt.title("Laufzeiten für verschiedene Sortieralgorithmen über die Samplegröße")
