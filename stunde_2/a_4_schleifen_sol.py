...
#%% Schreibe eine while Schleife, die ein Integer umdreht
num = 76542
umgedrehte_nummer = 0
print("Given Number ", num)
while num > 0:
    zwischenspeicher = num % 10
    umgedrehte_nummer = (umgedrehte_nummer * 10) + zwischenspeicher
    num = num // 10
print("Revere Number ", umgedrehte_nummer)
